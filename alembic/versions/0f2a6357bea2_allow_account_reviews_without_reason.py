"""Allow admin account decisions without a free-text reason.

The function retains its role checks, optimistic version guard, and access event.
Its nullable reason parameter remains for compatibility with older clients.
"""
...
revision: str = "0f2a6357bea2"
down_revision: str | None = "dd2fb9d36bb2"
...
def downgrade() -> None:
    raise RuntimeError("Account review policy changes require a reviewed forward migration")
